...
class DETRVAE(nn.Module):
    ...
    def __init__(self, backbones, transformer, encoder, state_dim, num_queries, camera_names):
        ...
        if backbones is not None:
            ...
            # input_dim = 4 + 7 # robot_state + env_state
            self.input_proj_robot_state = nn.Linear(4, hidden_dim)
...
class CNNMLP(nn.Module):
    def __init__(self, backbones, state_dim, camera_names):
        ...
        if backbones is not None:
            ...
            self.mlp = mlp(input_dim=mlp_in_dim, hidden_dim=1024, output_dim=4, hidden_depth=2)
        else:
    ...
    def forward(self, qpos, image, env_state, actions=None):
        ...
        features = torch.cat([flattened_features, qpos], axis=1) # qpos: 4
